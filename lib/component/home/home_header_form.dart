...
import 'package:flutter_ui_airbnb/component/common/common_form_field.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Align(
        ...
        alignment: screenWidth < 520 ? const Alignment(0,0) : const Alignment(-0.6, 0),
        child: Container(
          width: 420,
  ...
  Widget _buildFormTitle() {
    return Column(
      children: [
        ...
        Text(
          "혼자하는 여행에 적합한 개인실부터 여럿이 함께하는 여행에 좋은 '공간 전체' 숙소까지 모두의숙소에 다 있습니다.",
          style: body1(),
        ),
